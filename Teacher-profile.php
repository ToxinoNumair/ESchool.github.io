...
<title>E-School</title>
  ...
  <link href="https://fonts.googleapis.com/icon?family=Material+Icons" rel="stylesheet">
	...
	<link rel="stylesheet" href="css/Teacher-profile.css?v=<?php echo time(); ?>">
</head>
<body>
...
<div class="inner-body">
      ...
      <div class="update-dp">
          ...
          <input type="file" id="myfile" name="myfile"> <button>Upload</button>
      </div>
  
      <div class="Updatepassword">
        <h5>Change Password</h5>
          <input type="password" required placeholder="New Password"><br>
      ...
      <div class="Updatedata">
        <h5>Update Personal Info</h5>
          ...
          <input type="text"required placeholder="Qualification"><br>
